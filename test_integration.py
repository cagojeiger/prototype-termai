...
def test_imports():
    ...
    try:
        from ai.context_manager import ContextManager  # noqa: F401
        from ai.ollama_client import create_ollama_client  # noqa: F401
        from ai.realtime_analyzer import RealtimeAnalyzer  # noqa: F401
