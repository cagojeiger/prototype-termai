...
class TerminalManager:
    ...
    def __init__(self, ai_analyzer=None):
        ...
        self.on_command_start: Callable[[str], None] | None = None
        self.on_command_end: Callable[[str, int], None] | None = None
        self.on_directory_change: Callable[[str], None] | None = None
