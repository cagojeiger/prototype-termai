...
class OllamaClient:
    ...
    async def analyze_command_error(
        self, command: str, error_output: str, context: Optional[str] = None
    ) -> AIResponse:
...
"""
    ...
    async def analyze_command_output(
        self, command: str, output: str, context: Optional[str] = None
    ) -> AIResponse:
...
"""
    ...
    async def suggest_command(
        self, intent: str, context: Optional[str] = None
    ) -> AIResponse:
